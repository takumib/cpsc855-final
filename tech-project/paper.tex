...
\title{An Extensible Approach to Verification of Embedded Systems}
...
\keywords{automation, components, formal methods, specification, verifying compiler, embedded systems, wireless sensing}

\input{introduction.tex}
\input{telos_platform.tex}
\input{specify_led.tex}
\input{implementation.tex}
\input{led_trans.tex}
\input{related_works_and_conclusion.tex}
